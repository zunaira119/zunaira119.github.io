    ...
    ${p.map(i=>`
      <div class="card">
        ...
        <div class="links">
          ...
          ${i.live?`<a href="${i.live}" target="_blank">Live</a>`:""}
        </div>
      </div>
    `).join("")}
  </div>
